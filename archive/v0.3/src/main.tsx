...
function SettingsPage({ settings, setSettings }: { settings: Settings; setSettings: React.Dispatch<React.SetStateAction<Settings>> }) {
  ...
  return (
    <section className="settingsCard">
      ...
      <h3>Night display</h3>
      <p>The app dimmer affects Astronomy Companion itself. The software dimmer is guaranteed to work inside Astronomy Companion. Hardware backlight control is intentionally left for a later Windows-specific feature.</p>

      <div className="settingsDivider" />
      <h3>Offline behavior</h3>
      <p>The v0.3 Sun, Moon, and planet calculations are built into the app. Current positions and event searches do not call an online astronomy service.</p>
    </section>
  );
}
